...
<div class=" container-fluid" >
	<div class="col-md-6 offset-md-3">
		<div class="card bg-light mb-3" style="min-width: 100%;">
		  ...
		  <div class="card-header">LOGIN TO OLTEGA</div>
		  <div class="card-body">
		  		<div class="container">
				  <div class="row">
				    <div class="col-sm">
					    <div class="form-group">
					    	<input type="text" class="form-control" name="USERNAME" id="USERNAME" size="20" maxlength="100" required autofocus  placeholder="username/email" />
					    </div>
					    <div class="form-group">
					    	<input type="password" class="form-control" name="PASSWORD" id="PASSWORD" size="20" maxlength="42" required />
					    </div>
					    <div class="form-group">
					    	<div class="row">
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<input type="submit" value="<?php echo _( 'Sign In to OLTega' ); ?>" class="btn btn-danger" />
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
					    ...
					    <div class="form-group">
					    	<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										This is a restricted network. Use of this network, its equipment, and resources is monitored at all times and requires explicit permission from the network administrator and %s. If you do
									</div>
								</div>
							</div>
					    </div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<a href="index.php?create_account=user&amp;staff_id=new" rel="nofollow">
													<?php echo _( 'Add New User Account' ); ?>
												</a>
											</div>
										</div>
									<?php endif;
										...
										<div class="col-md-6">
											<div class="form-group">
												<a href="index.php?create_account=student&amp;student_id=new" rel="nofollow">
													<?php echo _( 'Add New Student Account' ); ?>
												</a>
											</div>
										</div>
									<?php endif;
	...
	if ( count( $RosarioLocales ) > 1 ) : ?>
		...
		<tr>
			...
			<?php foreach ( $RosarioLocales as $loc ) :
				...
				<a href="index.php?locale=<?php echo $loc; ?>" style="vertical-align: middle;" title="<?php echo htmlspecialchars( $language, ENT_QUOTES ); ?>">
