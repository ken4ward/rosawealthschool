	...
	<div class=" container-fluid" style="margin-top: 5%;">
		...
		<div class="card bg-light mb-3" style="min-width: 100%;">
		  ...
		  <div class="card-body">
		    ...
		    <p class="card-text" style="min-width: 100%;">
		    	<div class="form-group">
		    		<input type="text" name="email" id="email" class="form-control" size="25" maxlength="255" tabindex="1" pattern="[^ @]*@[^ @]*" required autofocus placeholder="Example: contacts@oltega.com" />
		    	</div>
		    	<div class="form-group">
		    		<button type="submit" class="btn btn-danger" style="min-width: 100%;"> SEND INSTRUCTION TO RESET PASSWORD </button>
		    	</div>
		    </p>
		  </div>
	</div>
